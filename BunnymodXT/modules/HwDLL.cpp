...
{
	USAGE("Usage: bxt_split <name>\n Tells BunnySplit to split by this the specified map name, and prints to console the current time. Mostly intended to be used in scripts, or in custom triggers (these may not be valid in runs, check the rules for your game/category).\n");
